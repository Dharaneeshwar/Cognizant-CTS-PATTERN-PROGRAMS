...
The function allDigitSum(int *arr, int LENGTH) accepts an array arr and an integer LENGTH as the size of arr. It is supposed to return the sum of digits of all the integers in the array.
